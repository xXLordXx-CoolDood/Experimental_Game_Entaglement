...
public struct ArduinoDeviceState : IInputStateTypeInfo
{
    ...
    [InputControl(name = "Button3", layout = "Button", bit = 2, displayName = "Gun1Up")]
    [InputControl(name = "Button4", layout = "Button", bit = 4, displayName = "Gun1Down")]
    [InputControl(name = "Button5", layout = "Button", bit = 5, displayName = "Gun2Up")]
    [InputControl(name = "Button6", layout = "Button", bit = 6, displayName = "Gun2Down")]
    [InputControl(name = "Button7", layout = "Button", bit = 7, displayName = "Gun3Up")]
    [InputControl(name = "Button8", layout = "Button", bit = 8, displayName = "Gun3Down")]
    [InputControl(name = "Button9", layout = "Button", bit = 9, displayName = "Forward")]
    [InputControl(name = "Button10", layout = "Button", bit = 10, displayName = "Reverse")]
    [InputControl(name = "Button11", layout = "Button", bit = 11, displayName = "Shoot Right")]
    [InputControl(name = "Button12", layout = "Button", bit = 12, displayName = "Back Right Leg")]
    [InputControl(name = "Button13", layout = "Button", bit = 13, displayName = "Front Left Leg")]
    [InputControl(name = "Button14", layout = "Button", bit = 14, displayName = "Front Right Leg")]
    [InputControl(name = "Button15", layout = "Button", bit = 15, displayName = "Back Left Leg")]
    [InputControl(name = "Button16", layout = "Button", bit = 16, displayName = "Turn Left")]
    [InputControl(name = "Button17", layout = "Button", bit = 17, displayName = "Turn Right")]
...
public class ArduinoDevice : InputDevice
{
    ...
    protected override void FinishSetup()
    {
        ...
        gun1up    = GetChildControl<ButtonControl>("Button3");
        gun1down   = GetChildControl<ButtonControl>("Button4");
        gun2up    = GetChildControl<ButtonControl>("Button5");
        gun2down    = GetChildControl<ButtonControl>("Button6");
        gun3up  = GetChildControl<ButtonControl>("Button7");
        gun3down   = GetChildControl<ButtonControl>("Button8");
